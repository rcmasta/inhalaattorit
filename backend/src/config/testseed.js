...
const insertInhalatorReq = db.prepare(`
...
const insertInhalers = db.prepare(`
...
const insertDrugForm = db.prepare(`
...
const insertDrugPurpose = db.prepare(`
    INSET INTO drug_purpose (name) VALUES
        ('Hoitava lääke'),
        ('Oirelääke');
`);

// medicine <--> medicine_active_ingredient <--> active_ingredient <--> drug_class 
const insertActiveIngredient = db.prepare(`
...
const insertDrugClass = db.prepare(`
